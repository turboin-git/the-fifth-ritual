    ...
    <div className="min-h-screen bg-gray-950 text-white pb-24">
        ...
        <div className="bg-gray-900 rounded-2xl p-5 border border-gray-800">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="bg-purple-600 hover:bg-purple-700 text-white font-bold tracking-widest py-3 rounded-xl text-xs transition"
            >
              MANAGE BOOKING
            </button>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-gray-950 border-t border-gray-800 px-6 py-3 flex justify-around">
        {[
          ...
          ), label: 'Stock', path: '/stock', active: false },
        ].map((item) => (
          <button
            key={item.label}
